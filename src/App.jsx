...
export default function App() {
  ...
  return (
    <>
      <title>ClassDoom - A Platform That Wil Help You To Manage Classroom</title>
      <div className="google-sans">
        <header className="shadow-lg w-screen h-[60px] flex justify-around items-center">
          <p className="text-[#003EA8] font-bold text-[20px]">SuperDoom</p>
        ...
        <div className="px-[10px]">
          <p className="mt-[40px] text-[60px]">SuperDoom</p>
